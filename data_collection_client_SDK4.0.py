...
def create_collection_directory():
    """
    This function creates a directory named 'collection' inside the 'Documents' directory of the current user's home directory.
...
def create_sdk_output_objects(zed):
    ...
    display_resolution = sl.Resolution(width, height)
...
def process_objects(objects, cam_w_pose):
    ...
    if len(objects.object_list):
        ...
        for obj in objects.object_list:
            ...
            pose_data = cam_w_pose.pose_data()
